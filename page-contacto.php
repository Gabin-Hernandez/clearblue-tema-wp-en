...
<!-- Script para animaciones y formulario -->
<script>
        ...
        contactForm.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    formMessage.textContent = data.data || 'An error occurred while processing your request.';
                }
            } catch (error) {
                formMessage.classList.remove('hidden');
                formMessage.classList.add('bg-red-100', 'text-red-800');
                formMessage.textContent = 'There was a connection error. Please try again later.';
            } finally {
                // Restaurar botón
                btn.disabled = false;
