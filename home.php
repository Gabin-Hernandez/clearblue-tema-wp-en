 ...
 * Description: Main blog listing page with pagination
 * Shows 7 posts per page configured via pre_get_posts in functions.php
 */
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <a href="<?php echo esc_url(get_permalink(get_option('page_for_posts'))); ?>" 
                               class="inline-block px-4 py-2 rounded-full font-semibold transition-colors bg-gray-100 text-gray-700 hover:bg-secondary hover:text-white">
                                All
                            </a>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php foreach ($tags as $tag) : ?>
                                <a href="<?php echo esc_url(get_tag_link($tag->term_id)); ?>" 
                                   class="inline-block px-3 py-1 rounded-full text-sm font-medium transition-colors bg-gray-100 text-gray-700 hover:bg-secondary hover:text-white">
        ...
        <?php if (have_posts()) : ?>
            ...
            <div class="mb-8">
                <p class="text-gray-600 text-lg">
                    ...
                    printf(
                        esc_html__('Showing %d-%d of %d articles', 'creatblue'),
                        $start,
                        $end,
                        $total
                    );
            ...
            if ($pagination) :
            ?>
                <nav class="pagination-wrapper flex justify-center" role="navigation" aria-label="Posts pagination">
                    <?php echo $pagination; ?>
                </nav>
            <?php endif; ?>
        ...
        <?php else : ?>
            ...
            <div class="max-w-2xl mx-auto text-center py-16">
                ...
                <a href="<?php echo esc_url(home_url('/')); ?>" 
                   class="inline-flex items-center gap-2 bg-secondary hover:bg-primary text-white px-8 py-4 rounded-full font-bold transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
